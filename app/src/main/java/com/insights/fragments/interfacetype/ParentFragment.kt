...
import com.insights.databinding.FragmentParentBinding
...
class ParentFragment : BaseFragment<FragmentParentBinding>() {
    override fun getFragmentBinding(
        ...
        container: ViewGroup?
    ): FragmentParentBinding = FragmentParentBinding.inflate(layoutInflater)

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        binding.tvSurvey.setOnClickListener {
            findNavController().navigate(R.id.action_parentFragment_to_surveyFragment)
        }
